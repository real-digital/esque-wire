...
offsetForLeaderEpochRequestDataSerializers: Dict[
    int, DataClassSerializer[OffsetForLeaderEpochRequestData]
] = {
    version: DataClassSerializer(OffsetForLeaderEpochRequestData, schema)
