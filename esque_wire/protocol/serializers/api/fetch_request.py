...
from esque_wire.protocol.structs.fetch_request import (
    FetchRequestData,
    ForgottenTopicsData,
    Partition,
    Topic,
...
forgottenTopicsDataSerializers: Dict[int, DataClassSerializer[ForgottenTopicsData]] = {
    version: DataClassSerializer(ForgottenTopicsData, schema) for version, schema
    in forgottenTopicsDataSchemas.items()
}
...
fetchRequestDataSchemas: Dict[int, Schema] = {
    0: [
        ...
        ('forgotten_topics_data', DummySerializer(ArraySerializer(forgottenTopicsDataSerializers[0]).default)),
...
fetchRequestDataSerializers: Dict[int, DataClassSerializer[FetchRequestData]] = {
    version: DataClassSerializer(FetchRequestData, schema) for version, schema
    in fetchRequestDataSchemas.items()
}
