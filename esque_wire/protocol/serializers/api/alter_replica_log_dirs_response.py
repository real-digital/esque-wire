...
alterReplicaLogDirsResponseDataSerializers: Dict[int, DataClassSerializer[AlterReplicaLogDirsResponseData]] = {
    version: DataClassSerializer(AlterReplicaLogDirsResponseData, schema) for version, schema
    in alterReplicaLogDirsResponseDataSchemas.items()
}
