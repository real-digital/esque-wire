...
from esque_wire.protocol.structs.describe_acls_request import (
...
describeAclsRequestDataSerializers: Dict[int, DataClassSerializer[DescribeAclsRequestData]] = {
    version: DataClassSerializer(DescribeAclsRequestData, schema) for version, schema
    in describeAclsRequestDataSchemas.items()
}
