...
topicErrorSerializers: Dict[int, DataClassSerializer[TopicError]] = {
    version: DataClassSerializer(TopicError, schema) for version, schema
    in topicErrorSchemas.items()
}
...
createPartitionsResponseDataSerializers: Dict[int, DataClassSerializer[CreatePartitionsResponseData]] = {
    version: DataClassSerializer(CreatePartitionsResponseData, schema) for version, schema
    in createPartitionsResponseDataSchemas.items()
}
