...
protocolSerializers: Dict[int, DataClassSerializer[Protocol]] = {
    version: DataClassSerializer(Protocol, schema) for version, schema
    in protocolSchemas.items()
}
...
joinGroupRequestDataSerializers: Dict[int, DataClassSerializer[JoinGroupRequestData]] = {
    version: DataClassSerializer(JoinGroupRequestData, schema) for version, schema
    in joinGroupRequestDataSchemas.items()
}
