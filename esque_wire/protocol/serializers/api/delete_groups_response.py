...
groupErrorCodeSerializers: Dict[int, DataClassSerializer[GroupErrorCode]] = {
    version: DataClassSerializer(GroupErrorCode, schema) for version, schema
    in groupErrorCodeSchemas.items()
}
...
deleteGroupsResponseDataSerializers: Dict[int, DataClassSerializer[DeleteGroupsResponseData]] = {
    version: DataClassSerializer(DeleteGroupsResponseData, schema) for version, schema
    in deleteGroupsResponseDataSchemas.items()
}
