...
listOffsetsRequestDataSerializers: Dict[int, DataClassSerializer[ListOffsetsRequestData]] = {
    version: DataClassSerializer(ListOffsetsRequestData, schema) for version, schema
    in listOffsetsRequestDataSchemas.items()
}
