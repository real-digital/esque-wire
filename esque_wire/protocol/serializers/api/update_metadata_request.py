...
endPointSerializers: Dict[int, DataClassSerializer[EndPoint]] = {
    version: DataClassSerializer(EndPoint, schema) for version, schema
    in endPointSchemas.items()
}
...
liveBrokerSchemas: Dict[int, Schema] = {
    0: [
        ...
        ('end_points', DummySerializer(ArraySerializer(endPointSerializers[0]).default)),
...
liveBrokerSerializers: Dict[int, DataClassSerializer[LiveBroker]] = {
    version: DataClassSerializer(LiveBroker, schema) for version, schema
    in liveBrokerSchemas.items()
}
...
updateMetadataRequestDataSerializers: Dict[int, DataClassSerializer[UpdateMetadataRequestData]] = {
    version: DataClassSerializer(UpdateMetadataRequestData, schema) for version, schema
    in updateMetadataRequestDataSchemas.items()
}
