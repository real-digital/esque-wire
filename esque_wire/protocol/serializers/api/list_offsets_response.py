...
listOffsetsResponseDataSerializers: Dict[int, DataClassSerializer[ListOffsetsResponseData]] = {
    version: DataClassSerializer(ListOffsetsResponseData, schema) for version, schema
    in listOffsetsResponseDataSchemas.items()
}
