...
syncGroupRequestDataSerializers: Dict[int, DataClassSerializer[SyncGroupRequestData]] = {
    version: DataClassSerializer(SyncGroupRequestData, schema) for version, schema
    in syncGroupRequestDataSchemas.items()
}
