...
from esque_wire.protocol.structs.metadata_request import (
    MetadataRequestData,
    Topic,
)
...
metadataRequestDataSerializers: Dict[int, DataClassSerializer[MetadataRequestData]] = {
    version: DataClassSerializer(MetadataRequestData, schema) for version, schema
    in metadataRequestDataSchemas.items()
}
