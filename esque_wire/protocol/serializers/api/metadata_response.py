...
brokerSerializers: Dict[int, DataClassSerializer[Broker]] = {
    version: DataClassSerializer(Broker, schema) for version, schema
    in brokerSchemas.items()
}
...
metadataResponseDataSerializers: Dict[int, DataClassSerializer[MetadataResponseData]] = {
    version: DataClassSerializer(MetadataResponseData, schema) for version, schema
    in metadataResponseDataSchemas.items()
}
