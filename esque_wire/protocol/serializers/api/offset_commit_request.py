...
offsetCommitRequestDataSerializers: Dict[int, DataClassSerializer[OffsetCommitRequestData]] = {
    version: DataClassSerializer(OffsetCommitRequestData, schema) for version, schema
    in offsetCommitRequestDataSchemas.items()
}
