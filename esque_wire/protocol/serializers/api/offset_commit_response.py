...
offsetCommitResponseDataSerializers: Dict[int, DataClassSerializer[OffsetCommitResponseData]] = {
    version: DataClassSerializer(OffsetCommitResponseData, schema) for version, schema
    in offsetCommitResponseDataSchemas.items()
}
